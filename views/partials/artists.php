        ...
        foreach($arr as $value) {
            echo '<div class="painting-card">';
                echo '<div class="painting-image-wrapper">'; // Новая обертка
                    echo '<img src="images/' .htmlspecialchars( $value['picture'], ENT_QUOTES, 'UTF-8' ).'" class="painting-image" alt="' . htmlspecialchars($value['title'], ENT_QUOTES, 'UTF-8') . '">'; // Изображение внутри обертки
