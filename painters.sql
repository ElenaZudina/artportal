...
INSERT INTO `artists` (`id`, `name`, `country`, `birth_date`, `bio`, `picture`, `created_at`, `user_id`) VALUES
(1, 'Lada Kalasho', 'Estonia', '1976-01-14', 'Borned in Ukraine', NULL, '2026-01-28 11:06:17', 4),
(2, 'Viktoriia Slavinska', 'Ukraine', '1976-01-01', 'Borned in Ukraine. ', NULL, '2026-01-28 11:09:28', 5),
(3, 'Elena Sizonenko', 'Ukraine', '1987-05-20', 'Test', NULL, '2026-01-29 08:49:46', 6),
(4, 'Marina Beikmane', 'Latvia', '1978-04-18', 'From Latvia', NULL, '2026-01-29 09:06:17', 7);
...
--
ALTER TABLE `paintings`
  ADD CONSTRAINT `paintings_ibfk_1` FOREIGN KEY (`style_id`) REFERENCES `styles` (`id`) ON UPDATE CASCADE,
