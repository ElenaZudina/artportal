                ...
                <div class="list-group-item mb-3 p-3 rounded-3 shadow-sm">
                    <div class="d-flex align-items-start gap-3">
                        <div style="width:120px; flex:0 0 120px;">
                            <a href="../paintings?id=<?php echo (int)($request['painting_id'] ?? 0); ?>" class="d-block">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-1">
                                <a href="../paintings?id=<?php echo (int)($request['painting_id'] ?? 0); ?>" class="text-reset text-decoration-none">
                            ...
                            <a href="../paintings?id=<?php echo (int)($request['painting_id'] ?? 0); ?>" class="btn btn-sm btn-outline-primary">View painting</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
